...
const About = () => {
  return (
    <Container className='w-75'>
      <Title>About</Title>
      <img src='https://prasadyash2411.github.io/ecom-website/img/Band%20Members.png' className='rounded-circle float-start' style={{width:"200px", height:"200px"}} alt="band img"/>
      <p>
